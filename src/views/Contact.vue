...
<template>
      <div class="relative bg-white rounded-lg overflow-hidden shadow-xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3">
          <!-- Contact information -->
          <div class="relative overflow-hidden py-10 px-6 bg-gradient-to-r from-red-400 to-pink-500 sm:px-10 xl:p-12">
            ...
            <dl class="mt-8 space-y-6">
              ...
              <dd class="flex text-base text-purple-50">
                <PhoneIcon class="flex-shrink-0 w-6 h-6 text-purple-200" aria-hidden="true" />
                <span class="ml-3">+1 (555) 123-4567</span>
              </dd>
              <dt><span class="sr-only">Email</span></dt>
              <dd class="flex text-base text-purple-50">
                <MailIcon class="flex-shrink-0 w-6 h-6 text-purple-200" aria-hidden="true" />
                <span class="ml-3">support@workcation.com</span>
              </dd>
            </dl>
            <ul class="mt-8 flex space-x-12" role="list">
              <li>
                <a class="text-purple-200 hover:text-purple-100" href="#">
          ...
          <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
            ...
            <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
              ...
              <div class="sm:col-span-2 sm:flex sm:justify-end">
                <button type="submit" class="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gradient-to-r from-purple-600 to-purple-700 focus:outline-none hover:from-purple-700 hover:to-purple-800 sm:w-auto">
                  Submit
                </button>
              </div>
            </form>
